...
function DevCard({ dev }: { dev: OwnedDev }) {
  ...
  return (
    ...
    >
      ...
      {/* Activity Status */}
      <div className={`absolute top-1 right-1 text-[8px] font-bold px-1 z-10 ${
          dev.currentHp <= 0 ? 'text-red-500 border border-red-500' :
...
function ArtifactSlot({ devUid, artifactUid, slotIndex }: { devUid: string, artifactUid?: string, slotIndex: number }) {
